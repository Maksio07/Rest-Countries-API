	...
	return (
		<form className='search-box flex justify-between my-[4rem] w-full' >
			...
			<select
				...
				<option  value='' className='input-field-option'>Filter by region</option>
				<option  value='africa' className='input-field-option'>Africa</option>
				<option  value='america' className='input-field-option'>America</option>
				<option  value='asia' className='input-field-option'>Asia</option>
				<option value='europe' className='input-field-option'>Europe</option>
				<option  value='oceania' className='input-field-option'>Oceania</option>
			</select>
		</form>
	)
}
